...
> 最后更新：2026-05-06
> 当前 commit：[`f5420b4`](https://github.com/QQhuxuhui/sparkcode-studio/commit/f5420b4)
...
| 模板示例图 | 阿里云 OSS（待启用）/ 当前用 GitHub raw URL | 大体量（430+ 张） |
...
- [ ] **OSS 凭证就绪后跑** `pnpm import:templates --with-images --reset` 把 430 张示例图从 GitHub 搬到阿里云 OSS（国内访问速度提升 10×）
